...
class FeederCheckerTests(unittest.TestCase):
    ...
    def test_combined_supported_feeder_passes_numerical_checks(self):
        ...
        self.assertEqual(r.overall_outcome, "PASS")
    ...
    def test_voltage_drop_can_be_integrated_with_explicit_limit(self):
        r = check_feeder(self._feeder(
            length_m=100,
            voltage_drop_cross_section_mm2=95,
            voltage_drop_material="copper",
        ...
        self.assertNotEqual(r.overall_outcome, "NOT VERIFIED")

    def test_voltage_drop_without_limit_stays_not_verified(self):
        r = check_feeder(self._feeder(
            length_m=100,
            voltage_drop_cross_section_mm2=95,
            voltage_drop_material="copper",
